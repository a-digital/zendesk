...
namespace adigital\zendesk\widgets;

use adigital\zendesk\Zendesk;
use adigital\zendesk\assetbundles\zendeskwidgetwidget\ZendeskWidgetWidgetAsset;
 ...
 * @since     1.0.0
 */
class ZendeskWidget extends Widget
{
    ...
    public function init(): void
    {
        ...
        if ($this->name === '') {
	        $this->name = Craft::$app->getUser()->getIdentity()->name;
        }
        if ($this->email === '') {
	        $this->email = Craft::$app->getUser()->getIdentity()->email;
        }
    }
    ...
    public static function displayName(): string
    {
        ...
        return Craft::t('zendesk', $widgetName);
    }
